...
export const GRAPHIC_DATA ={
  ...
  //SETTLEMENT_KOMA: new Graphic("assets/pic/test_settlement.png"),
  SETTLEMENT_KOMA: new Graphic("assets/pic/test_treasure.png", new AnimationInfo(10,10,5,2,192,192)),
