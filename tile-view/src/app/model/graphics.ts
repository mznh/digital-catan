...
export const GRAPHIC_DATA ={
  ...
  NUMBER_PLATE: new Map<number, Graphic>([
    [ 2,new Graphic("assets/pic/number/2.png", new AnimationInfo(1,10,1,1,200,200))],
    [ 3,new Graphic("assets/pic/number/3.png", new AnimationInfo(1,10,1,1,200,200))],
    [ 4,new Graphic("assets/pic/number/4.png", new AnimationInfo(1,10,1,1,200,200))],
    [ 5,new Graphic("assets/pic/number/5.png", new AnimationInfo(1,10,1,1,200,200))],
    [ 6,new Graphic("assets/pic/number/6.png", new AnimationInfo(1,10,1,1,200,200))],
    [ 7,new Graphic("assets/pic/number/7.png", new AnimationInfo(1,10,1,1,200,200))],
    [ 8,new Graphic("assets/pic/number/8.png", new AnimationInfo(1,10,1,1,200,200))],
    [ 9,new Graphic("assets/pic/number/9.png", new AnimationInfo(1,10,1,1,200,200))],
    [10,new Graphic("assets/pic/number/10.png", new AnimationInfo(1,10,1,1,200,200))],
    [11,new Graphic("assets/pic/number/11.png", new AnimationInfo(1,10,1,1,200,200))],
    [12,new Graphic("assets/pic/number/12.png", new AnimationInfo(1,10,1,1,200,200))],
  ]),
...
export const GRAPHIC_POSITION = {
  ...
  NUMBER_PLATE: new Map([
    [ 2,new Point(150, 150, 0)],
    [ 3,new Point(150, 150, 0)],
    [ 4,new Point(150, 150, 0)],
    [ 5,new Point(150, 150, 0)],
    [ 6,new Point(150, 150, 0)],
    [ 8,new Point(150, 150, 0)],
    [ 9,new Point(150, 150, 0)],
    [10,new Point(150, 150, 0)],
    [11,new Point(150, 150, 0)],
    [12,new Point(150, 150, 0)],
  ]),
}
